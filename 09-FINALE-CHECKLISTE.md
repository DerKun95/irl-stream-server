...
3. **Sie macht den Bot zum Mod** – in ihrem Chat: `/mod wnderlandbot`
...
5. **Ihr Moblin** (einmalig): URL `srt://DEIN-NAME.duckdns.org:53127?latency=2000000`,
...
- [ ] Danach in der FritzBox die **Portfreigabe (UDP 53127)** auf das neue
...
| Was                  | Wert                                                  |
|----------------------|-------------------------------------------------------|
| SRT-Empfang (OBS)    | `srt://0.0.0.0:53127?mode=listener&latency=2000000`   |
| Moblin-URL           | `srt://DEIN-NAME.duckdns.org:53127?latency=2000000`   |
| Portfreigabe         | FritzBox UDP 53127 → Laptop                           |
| DynDNS               | DuckDNS (nur IPv4!), FritzBox hält aktuell            |
| OBS-Fernsteuerung    | WebSocket Port 4455 (Passwort in config.ini)          |
| Bot-Account          | wnderlandbot                                          |
